...
| `--plot-ylim`| Set Y-axis limits, format as two space separated numbers (e.g. `--plot-ylim 0 10`). To keep minimum or maximum values, use "min" or "max" (e.g. `--plot-ylim min 10`, or `--plot-ylim -1 max`).                                    | `None`                               |
| `--plot-doclim`| Minimum and maximum normalised depth of coverage to use for plotting and bkp analysis (e.g. `--plot-ylim 0 10`). To keep minimum or maximum values, use "min" or "max" (e.g. `--plot-ylim min 10`, or `--plot-ylim -1 max`).              | `None`                               |
